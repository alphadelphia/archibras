...
// Copyright (c) 2017- The Harmonian developers
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < (uint64)15000000 + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        ThreadSafeMessageBox(strMessage, "Harmonian", wxOK | wxICON_EXCLAMATION | wxMODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        CBlock(hash=0000570482067aede916, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=3a7dcafb61, nTime=1513366603, nBits=1f00ffff, nNonce=61747, vtx=1, vchBlockSig=)
          Coinbase(hash=3a7dcafb61, nTime=1345083810, ver=1, vin.size=1, vout.size=1, nLockTime=0)
            CTxIn(COutPoint(0000000000, -1), coinbase 04ffff001d020f274c584c612073c3a972696520646973747269627565206c6573206861726d6f6e6965732e204c65732061747472616374696f6e7320736f6e742070726f706f7274696f6e6e656c6c6573206175782064657374696ec3a965732e)
            CTxOut(empty)
          vMerkleTree: 3a7dcafb61 
        */
